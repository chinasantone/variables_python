...
print('el nombre del padre es:', nombre_padre1)
print('Ingrese nombre completo de la madre:')
nombre_padre2 = str(input())
print('el nombre de la madre es:', nombre_padre2)
print('Ingrese su nombre:')
nombre_hijo = str(input())
print('el nombre del hijo es:', nombre_hijo)
splitapellido_padre1 = nombre_padre1.split(" ")
print(splitapellido_padre1[-1])
splitapellido_padre2 = nombre_padre2.split(" ")
print(splitapellido_padre2[-1])
